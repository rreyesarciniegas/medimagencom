...
add_filter( 'wp_setup_nav_menu_item', 'mediclinic_mikado_add_custom_nav_fields');

// save menu custom fields
add_action( 'wp_update_nav_menu_item', 'mediclinic_mikado_update_custom_nav_fields', 10, 3 );

// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'mediclinic_mikado_edit_walker', 10, 2 );

function mediclinic_mikado_add_custom_nav_fields( $menu_item ) {
 ...
 * @return      void
*/
function mediclinic_mikado_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
 ...
 * @return      void
*/
function mediclinic_mikado_edit_walker($walker,$menu_id) {
	return 'MediclinicMikado_Walker_Nav_Menu_Edit_Custom';
}
...
include_once MIKADO_ROOT_DIR.'/includes/nav-menu/mobile-navigation-walker.php';
include_once MIKADO_ROOT_DIR.'/includes/nav-menu/fullscreen-navigation-walker.php';
include_once MIKADO_ROOT_DIR.'/includes/nav-menu/sticky-navigation-walker.php';
include_once MIKADO_ROOT_DIR.'/includes/nav-menu/vertical-compact-navigation-walker.php';