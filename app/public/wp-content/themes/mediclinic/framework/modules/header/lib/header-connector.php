<?php
namespace MediclinicMikado\Modules\Header\Lib;
/**
...
class HeaderConnector {
    ...
    public function connect($config = array()) {
        do_action('mediclinic_mikado_pre_header_connect');
        ...
        if(!empty($config['affect_content'])) {
            add_filter('mediclinic_mikado_content_elem_style_attr', array($this, 'contentMarginFilter'));
        }

        if(!empty($config['affect_title'])) {
            add_filter('mediclinic_mikado_title_content_padding', array($this, 'titlePaddingFilter'));
        }

        do_action('mediclinic_mikado_after_header_connect');
    }
     ...
     *
     * Hooks to mediclinic_mikado_title_content_padding filter
     *
     * @return int
     */
