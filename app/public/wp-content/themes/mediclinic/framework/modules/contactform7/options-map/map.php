...
if ( ! function_exists('mediclinic_mikado_contact_form_7_options_map') ) {

	function mediclinic_mikado_contact_form_7_options_map() {

		mediclinic_mikado_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'mediclinic'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = mediclinic_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'mediclinic')
		));

		//Text Typography

		$typography_text_group = mediclinic_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'mediclinic'),
			'description'	=> esc_html__('Setup typography for form elements text', 'mediclinic'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = mediclinic_mikado_add_admin_row(array(
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'mediclinic'),
		));
		...
		$typography_text_row2 = mediclinic_mikado_add_admin_row(array(
		...
		$typography_text_row3 = mediclinic_mikado_add_admin_row(array(
		...
		$typography_label_group = mediclinic_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'mediclinic'),
			'description'	=> esc_html__('Setup typography for form elements label', 'mediclinic'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = mediclinic_mikado_add_admin_row(array(
		...
		$typography_label_row2 = mediclinic_mikado_add_admin_row(array(
		...
		$background_border_group = mediclinic_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'mediclinic'),
			'description'	=> esc_html__('Setup form elements background and border style', 'mediclinic'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = mediclinic_mikado_add_admin_row(array(
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'mediclinic')
		));
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'mediclinic')
		));

		$background_border_row2 = mediclinic_mikado_add_admin_row(array(
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'mediclinic'),
		));
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'mediclinic')
		));
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'mediclinic')
		));

		$background_border_row3 = mediclinic_mikado_add_admin_row(array(
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'mediclinic'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'mediclinic'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = mediclinic_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'mediclinic'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = mediclinic_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'mediclinic'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'mediclinic'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'mediclinic'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'mediclinic'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = mediclinic_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'mediclinic'),
			'description'	=> esc_html__('Setup form elements margin', 'mediclinic'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = mediclinic_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'mediclinic'),
			'description'	=> esc_html__('Enter height for textarea form element', 'mediclinic'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = mediclinic_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'mediclinic'),
			'description'	=> esc_html__('Setup button text typography', 'mediclinic'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = mediclinic_mikado_add_admin_row(array(
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Hover Text Color', 'mediclinic')
		));
		...
		$button_typography_row2 = mediclinic_mikado_add_admin_row(array(
		...
		$button_background_border_group = mediclinic_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'mediclinic'),
			'description'	=> esc_html__('Setup button background and border style', 'mediclinic'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = mediclinic_mikado_add_admin_row(array(
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'mediclinic')
		));
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'mediclinic')
		));

		$button_background_border_row2 = mediclinic_mikado_add_admin_row(array(
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'mediclinic')
		));
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'mediclinic')
		));

		$button_background_border_row3 = mediclinic_mikado_add_admin_row(array(
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'mediclinic'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		mediclinic_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'mediclinic'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = mediclinic_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'mediclinic')
		));
        ...
        $panel_contact_form_style_3 = mediclinic_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'mediclinic')
        ));
        ...
        $typography_label_row3 = mediclinic_mikado_add_admin_row(array(
        ...
        $button_typography_row3 = mediclinic_mikado_add_admin_row(array(
	...
	add_action( 'mediclinic_mikado_options_map', 'mediclinic_mikado_contact_form_7_options_map', 20);
}