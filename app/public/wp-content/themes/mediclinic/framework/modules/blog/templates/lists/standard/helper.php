...
if( !function_exists('mediclinic_mikado_get_blog_holder_classes') ) {
	/**
	 * Function that generates blog holder classes for blog page
	 */
	function mediclinic_mikado_get_blog_holder_classes($classes) {
		$new_classes   = array();
	...
	add_filter( 'mediclinic_mikado_blog_holder_classes', 'mediclinic_mikado_get_blog_holder_classes' );
}
