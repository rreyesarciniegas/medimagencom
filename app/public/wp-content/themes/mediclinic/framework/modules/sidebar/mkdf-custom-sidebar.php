...
if (!class_exists('MediclinicMikadoSidebar')) {

    class MediclinicMikadoSidebar
    {
        ...
        function __construct() {
            ...
            $this->title = esc_html__('Custom Widget Area', 'mediclinic');
        ...
        function load_assets() {
            ...
            wp_enqueue_script('mkd-sidebar', MIKADO_ROOT . '/framework/admin/assets/js/mkdf-sidebar.js');
            wp_enqueue_style('mkd-sidebar', MIKADO_ROOT . '/framework/admin/assets/css/mkdf-sidebar.css');
        }
        ...
        function template_add_widget_field() {
            ...
            echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '" . esc_html__('Enter Name of the new Widget Area', 'mediclinic') . "' name='mkd-add-widget' /></span>";
            echo "\n    <input class='button' type='submit' value='" . esc_html__('Add Widget Area', 'mediclinic') . "' />";
            echo "\n    " . $nonce;
            echo "\n  </form>";
            echo "\n</script>\n";
        }
		...
		function add_sidebar_area() {
			if ( ! empty( $_POST['mkd-add-widget'] ) ) {
				...
				$name           = $this->get_name( sanitize_text_field( $_POST['mkd-add-widget'] ) );
        ...
        function register_custom_sidebars() {
            ...
            $args = apply_filters('mediclinic_mikado_custom_widget_args', $args);
