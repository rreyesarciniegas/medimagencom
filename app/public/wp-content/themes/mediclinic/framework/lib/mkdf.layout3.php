...
/*
   Class: MediclinicMikadoMultipleImages
   A class that initializes Mikado Multiple Images
*/
class MediclinicMikadoMultipleImages implements iMediclinicMikadoRender {
	private $name;
	private $label;
	private $description;
	...
	function __construct($name,$label="",$description="") {
		...
		$mediclinic_mikado_Framework->mkdMetaBoxes->addOption($this->name,"");
	}
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="mkdf-gallery-uploader">
								<a class="mkdf-gallery-upload-btn btn btn-sm btn-primary" href="javascript:void(0)"><?php esc_html_e('Upload', 'mediclinic'); ?></a>
								<a class="mkdf-gallery-clear-btn btn btn-sm btn-default pull-right" href="javascript:void(0)"><?php esc_html_e('Remove All', 'mediclinic'); ?></a>
							</div>
						</div>
					</div>
				</div>
...
/*
   Class: MediclinicMikadoImagesVideos
   A class that initializes Mikado Images Videos
*/
class MediclinicMikadoImagesVideos implements iMediclinicMikadoRender {
	private $label;
	private $description;
	...
	public function render($factory) {
			...
			<div class="mkdf-page-form-section">
				...
				<div class="mkdf-section-content">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-2">
								<em class="mkdf-field-description"><?php esc_html_e('Order Number', 'mediclinic'); ?></em>
						...
						<div class="row next-row">
							<div class="col-lg-12">
								<em class="mkdf-field-description"><?php esc_html_e('Image', 'mediclinic'); ?></em>
								<div class="mkdf-media-uploader">
									<div style="display: none" class="mkdf-media-image-holder">
										<img src="" alt="<?php esc_attr_e('Image thumbnail', 'mediclinic'); ?>" class="mkdf-media-image img-thumbnail" />
									</div>
									...
									<a class="mkdf-media-upload-btn btn btn-sm btn-primary" href="javascript:void(0)" data-frame-title="<?php esc_attr_e('Select Image', 'mediclinic'); ?>" data-frame-button-text="<?php esc_html_e('Select Image', 'mediclinic'); ?>"><?php esc_html_e('Upload', 'mediclinic'); ?></a>
									<a style="display: none;" href="javascript: void(0)" class="mkdf-media-remove-btn btn btn-default btn-sm"><?php esc_html_e('Remove', 'mediclinic'); ?></a>
								</div>
							</div>
						</div>
						<div class="row next-row">
							<div class="col-lg-3">
								<em class="mkdf-field-description"><?php esc_html_e('Video Type', 'mediclinic'); ?></em>
								<select class="form-control mkdf-form-element mkdf-portfoliovideotype" name="portfoliovideotype_x" id="portfoliovideotype_x">
									<option value=""></option>
									<option value="youtube"><?php esc_html_e('YouTube', 'mediclinic'); ?></option>
									<option value="vimeo"><?php esc_html_e('Vimeo', 'mediclinic'); ?></option>
									<option value="self"><?php esc_html_e('Self Hosted', 'mediclinic'); ?></option>
								</select>
							</div>
							<div class="col-lg-3">
								<em class="mkdf-field-description"><?php esc_html_e('Video ID', 'mediclinic'); ?></em>
								<input type="text" class="form-control mkdf-input mkdf-form-element" id="portfoliovideoid_x" name="portfoliovideoid_x" />
							</div>
						</div>
						<div class="row next-row">
							<div class="col-lg-12">
								<em class="mkdf-field-description"><?php esc_html_e( 'Video image', 'mediclinic' ); ?></em>
								<div class="mkdf-media-uploader">
									<div style="display: none" class="mkdf-media-image-holder">
										<img src="" alt="<?php esc_attr_e('Image thumbnail', 'mediclinic'); ?>" class="mkdf-media-image img-thumbnail" />
									</div>
						...
						<div class="row next-row">
							<div class="col-lg-4">
								<em class="mkdf-field-description"><?php esc_html_e('Video mp4', 'mediclinic'); ?></em>
								<input type="text" class="form-control mkdf-input mkdf-form-element" id="portfoliovideomp4_x" name="portfoliovideomp4_x" />
							</div>
						</div>
						<div class="row next-row">
							<div class="col-lg-12">
								<a class="mkdf_remove_image btn btn-sm btn-primary" href="/" onclick="javascript: return false;"><?php esc_html_e('Remove portfolio image/video', 'mediclinic'); ?></a>
							</div>
						</div>
					</div>
				</div>
		...
		if (count($portfolio_images)>1 && mediclinic_mikado_core_plugin_installed()) {
								...
								<div class="col-lg-12">
									...
									<div class="mkdf-media-uploader">
										<div<?php if (stripslashes($portfolio_image['portfolioimg']) == false) { ?> style="display: none"<?php } ?> class="mkdf-media-image-holder">
											<img src="<?php if (stripslashes($portfolio_image['portfolioimg']) == true) { echo esc_url(mediclinic_mikado_get_attachment_thumb_url(stripslashes($portfolio_image['portfolioimg']))); } ?>" alt="<?php esc_attr_e('Image thumbnail', 'mediclinic'); ?>" class="mkdf-media-image img-thumbnail"/>
										</div>
										<div style="display: none" class="mkdf-media-meta-fields">
							...
							<div class="row next-row">
								<div class="col-lg-3">
									...
									<select class="form-control mkdf-form-element mkdf-portfoliovideotype" name="portfoliovideotype[]" id="portfoliovideotype_<?php echo esc_attr($no); ?>">
										<option value=""></option>
										<option <?php if ($portfolio_image['portfoliovideotype'] == "youtube") { echo "selected='selected'"; } ?>  value="youtube"><?php esc_html_e('YouTube', 'mediclinic'); ?></option>
										<option <?php if ($portfolio_image['portfoliovideotype'] == "vimeo") { echo "selected='selected'"; } ?>  value="vimeo"><?php esc_html_e('Vimeo', 'mediclinic'); ?></option>
										<option <?php if ($portfolio_image['portfoliovideotype'] == "self") { echo "selected='selected'"; } ?>  value="self"><?php esc_html_e('Self Hosted', 'mediclinic'); ?></option>
									</select>
								</div>
								<div class="col-lg-3">
									<em class="mkdf-field-description"><?php esc_html_e('Video ID', 'mediclinic'); ?></em>
								...
								<div class="col-lg-12">
									...
									<div class="mkdf-media-uploader">
										<div<?php if (stripslashes($portfolio_image['portfoliovideoimage']) == false) { ?> style="display: none"<?php } ?> class="mkdf-media-image-holder">
											<img src="<?php if (stripslashes($portfolio_image['portfoliovideoimage']) == true) { echo esc_url(mediclinic_mikado_get_attachment_thumb_url(stripslashes($portfolio_image['portfoliovideoimage']))); } ?>" alt="<?php esc_attr_e('Image thumbnail', 'mediclinic'); ?>" class="mkdf-media-image img-thumbnail"/>
										</div>
										<div style="display: none" class="mkdf-media-meta-fields">
		...
		?>
		<br />
		<a class="mkdf_add_image btn btn-sm btn-primary" onclick="javascript: return false;" href="/"><?php esc_html_e('Add portfolio image/video', 'mediclinic'); ?></a>
	<?php
	}
}
...
/*
   ...
   A class that initializes Mikado Images Videos
*/
class MediclinicMikadoImagesVideosFramework implements iMediclinicMikadoRender {
	private $label;
	private $description;
	...
	public function render($factory) {
		...
		<div class="mkdf-hidden-portfolio-images"  style="display: none">
			<div class="mkdf-portfolio-toggle-holder">
				<div class="mkdf-portfolio-toggle mkdf-toggle-desc">
					<span class="number">1</span><span class="mkdf-toggle-inner"><?php esc_html_e('Image - ', 'mediclinic'); ?><em><?php esc_html_e('Order Number', 'mediclinic'); ?></em></span>
				</div>
		...
		<div class="mkdf-hidden-portfolio-videos"  style="display: none">
			<div class="mkdf-portfolio-toggle-holder">
				<div class="mkdf-portfolio-toggle mkdf-toggle-desc">
					<span class="number">2</span><span class="mkdf-toggle-inner"><?php esc_html_e('Video - ', 'mediclinic'); ?><em><?php esc_html_e('Order Number', 'mediclinic'); ?></em></span>
				</div>
				<div class="mkdf-portfolio-toggle mkdf-portfolio-control">
					...
					<div class="mkdf-section-content">
						<div class="container-fluid">
							<div class="row">
								<div class="col-lg-2">
									<div class="mkdf-media-uploader">
										<em class="mkdf-field-description"><?php esc_html_e('Cover Video Image', 'mediclinic'); ?></em>
										<div style="display: none" class="mkdf-media-image-holder">
											<img src="" alt="<?php esc_attr_e('Image thumbnail', 'mediclinic'); ?>" class="mkdf-media-image img-thumbnail">
										</div>
										<div style="display: none" class="mkdf-media-meta-fields">
								...
								<div class="col-lg-10">
									...
									<div class="row next-row">
										...
										<div class="col-lg-2 mkdf-video-id-holder">
											<em class="mkdf-field-description" id="videoId"><?php esc_html_e('Video ID', 'mediclinic'); ?></em>
											<input type="text" class="form-control mkdf-input mkdf-form-element" id="portfoliovideoid_x" name="portfoliovideoid_x">
										</div>
									</div>
		...
		while (isset($portfolio_images[$no-1])) {
			...
			if ($portfolio_img_type == "image") {
				...
				<div class="mkdf-portfolio-images mkdf-portfolio-media" rel="<?php echo esc_attr($no); ?>">
					<div class="mkdf-portfolio-toggle-holder">
						<div class="mkdf-portfolio-toggle mkdf-toggle-desc">
							<span class="number"><?php echo esc_html($no); ?></span><span class="mkdf-toggle-inner"><?php esc_html_e('Image - ', 'mediclinic'); ?><em><?php echo stripslashes($portfolio_image['portfolioimgordernumber']); ?></em></span>
						</div>
						<div class="mkdf-portfolio-toggle mkdf-portfolio-control">
			...
			<?php
				...
				<div class="mkdf-portfolio-videos mkdf-portfolio-media" rel="<?php echo esc_attr($no); ?>">
					<div class="mkdf-portfolio-toggle-holder">
						<div class="mkdf-portfolio-toggle mkdf-toggle-desc">
							<span class="number"><?php echo esc_html($no); ?></span><span class="mkdf-toggle-inner"><?php esc_html_e('Video - ', 'mediclinic'); ?><em><?php echo stripslashes($portfolio_image['portfolioimgordernumber']); ?></em></span>
						</div>
						<div class="mkdf-portfolio-toggle mkdf-portfolio-control">
		...
		<div class="mkdf-portfolio-add">
			<a class="mkdf-add-image btn btn-sm btn-primary" href="#"><i class="fa fa-camera"></i><?php esc_html_e('Add Image', 'mediclinic'); ?></a>
			<a class="mkdf-add-video btn btn-sm btn-primary" href="#"><i class="fa fa-video-camera"></i><?php esc_html_e('Add Video', 'mediclinic'); ?></a>
			<a class="mkdf-toggle-all-media btn btn-sm btn-default pull-right" href="#"><?php esc_html_e('Expand All', 'mediclinic'); ?></a>
		</div>
	<?php
	}
}

class MediclinicMikadoTwitterFramework implements  iMediclinicMikadoRender {
    public function render($factory) {
        ...
        if(!empty($_GET['oauth_token']) && !empty($_GET['oauth_verifier'])) {
            ...
            if($responseObj->status) {
                $message = esc_html__('You have successfully connected with your Twitter account. If you have any issues fetching data from Twitter try reconnecting.', 'mediclinic');
            } else {
                $message = $responseObj->message;
            }
        }

        $buttonText = $twitterApi->hasUserConnected() ? esc_html__('Re-connect with Twitter', 'mediclinic') : esc_html__('Connect with Twitter', 'mediclinic');
    ?>
        <?php if($message !== '') { ?>
        ...
        <div class="mkdf-page-form-section" id="mkdf_enable_social_share">
            <div class="mkdf-field-desc">
                <h4><?php esc_html_e('Connect with Twitter', 'mediclinic'); ?></h4>
                <p><?php esc_html_e('Connecting with Twitter will enable you to show your latest tweets on your site', 'mediclinic'); ?></p>
            </div>
            <div class="mkdf-section-content">
                <div class="container-fluid">
                    <div class="row">
...
class MediclinicMikadoInstagramFramework implements  iMediclinicMikadoRender {
    public function render( $factory ) {
        ...
        if ( ! empty( $_GET['code'] ) && ! empty( $_GET['instagram'] ) ) {
            ...
            $message = esc_html__( 'You have successfully connected with your Instagram Personal account.', 'mediclinic' );
        }
        ...
        if ( ! empty( $_GET['access_token'] ) && ! empty( $_GET['facebook'] ) ) {
            ...
            $message = esc_html__( 'You have successfully connected with your Instagram Business account.', 'mediclinic' );
        }
        ...
        if ( ! empty( $_GET['disconnect'] ) ) {
            ...
            $message = esc_html__( 'You have have been disconnected from all Instagram accounts.', 'mediclinic' );
        ...
        <div class="mkdf-page-form-section" id="mkdf_enable_social_share">
            <div class="mkdf-field-desc">
                <h4><?php esc_html_e( 'Connect with Instagram', 'mediclinic' ); ?></h4>
                <p><?php esc_html_e( 'Connecting with Instagram will enable you to show your latest photos on your site', 'mediclinic' ); ?></p>
            </div>
            <div class="mkdf-section-content">
                <div class="container-fluid">
                    <?php
                    ...
                    if ( $instagram_user_id ) { ?>
                        <div class="row">
                            <div class="col-lg-12">
                                <p><?php echo esc_html__( 'You are currently connected to Instagram ID: ', 'mediclinic' );
                    ...
                    <div class="row">
                        <?php if ( ! empty( $_GET['disconnect'] ) ) { ?>
                            <div class="col-lg-4">
                                <a class="btn btn-primary" href="<?php echo esc_url( $instagram_api->reloadURL() ); ?>"><?php echo esc_html__( 'Reload Page', 'mediclinic' ); ?></a>
                            </div>
                        <?php } else if ( empty( $connection_type ) ) { ?>
                            <div class="col-lg-4">
                                <a class="btn btn-primary" href="<?php echo esc_url( $instagram_api->instagramRequestCode() ); ?>"><?php echo esc_html__( 'Connect with Instagram Personal account', 'mediclinic' ); ?></a>
                            </div>
                            <div class="col-lg-4">
                                <a class="btn btn-primary" href="<?php echo esc_url( $instagram_api->facebookRequestCode() ); ?>"><?php echo esc_html__( 'Connect with Instagram Business account', 'mediclinic' ); ?></a>
                            </div>
                        <?php } else { ?>
                            <div class="col-lg-4">
                                <a class="btn btn-primary" href="<?php echo esc_url( $instagram_api->disconnectURL() ); ?>"><?php echo esc_html__( 'Disconnect Instagram account', 'mediclinic' ) ?></a>
                            </div>
                        <?php } ?>
                    </div>
                </div>
...
/*
   ...
   A class that initializes Mikado Images Videos
*/
class MediclinicMikadoOptionsFramework implements iMediclinicMikadoRender {
	private $label;
	private $description;
	...
	public function render($factory) {
		...
		<div class="mkdf-portfolio-additional-item-holder" style="display: none">
			<div class="mkdf-portfolio-toggle-holder">
				<div class="mkdf-portfolio-toggle mkdf-toggle-desc">
					<span class="number">1</span><span class="mkdf-toggle-inner"><?php esc_html_e( 'Additional Sidebar Item ', 'mediclinic' ); ?><em><?php esc_html_e('(Order Number, Item Title)', 'mediclinic'); ?></em></span>
				</div>
				<div class="mkdf-portfolio-toggle mkdf-portfolio-control">
					...
					<div class="mkdf-section-content">
						<div class="container-fluid">
							<div class="row">
								...
								<div class="col-lg-10">
									<em class="mkdf-field-description"><?php esc_html_e('Item Title', 'mediclinic'); ?></em>
									<input type="text" class="form-control mkdf-input mkdf-form-element" id="optionLabel_x" name="optionLabel_x">
								</div>
							</div>
							<div class="row next-row">
								<div class="col-lg-12">
									<em class="mkdf-field-description"><?php esc_html_e('Item Text', 'mediclinic'); ?></em>
									<textarea class="form-control mkdf-input mkdf-form-element" id="optionValue_x" name="optionValue_x"></textarea>
								</div>
							</div>
							<div class="row next-row">
								<div class="col-lg-12">
									<em class="mkdf-field-description"><?php esc_html_e('Enter Full URL for Item Text Link', 'mediclinic'); ?></em>
		...
		if (count($portfolios)>1 && mediclinic_mikado_core_plugin_installed()) {
		...
		while (isset($portfolios[$no-1])) {
			...
			<div class="mkdf-portfolio-additional-item" rel="<?php echo esc_attr($no); ?>">
				<div class="mkdf-portfolio-toggle-holder">
					<div class="mkdf-portfolio-toggle mkdf-toggle-desc">
						<span class="number"><?php echo esc_html($no); ?></span><span class="mkdf-toggle-inner"><?php esc_html_e( 'Additional Sidebar Item - ', 'mediclinic' ); ?><em>(<?php echo stripslashes($portfolio['optionlabelordernumber']); ?><?php esc_html_e( ', ', 'mediclinic' ); ?><?php echo stripslashes($portfolio['optionLabel']); ?>)</em></span>
					</div>
					<div class="mkdf-portfolio-toggle mkdf-portfolio-control">
		...
		<div class="mkdf-portfolio-add">
			<a class="mkdf-add-item btn btn-sm btn-primary" href="#"><?php esc_html_e('Add New Item', 'mediclinic'); ?></a>
			<a class="mkdf-toggle-all-item btn btn-sm btn-default pull-right" href="#"><?php esc_html_e('Expand All', 'mediclinic'); ?></a>
		</div>
	<?php
	}
}

class MediclinicMikadoRepeater implements iMediclinicMikadoRender
{
    private $label;
    private $description;
    private $name;
    ...
    function __construct($fields, $name, $label = '', $description = '', $button_text = '')
    {
        ...
        foreach ($this->fields as $field) {
            ...
            $mediclinic_mikado_Framework->mkdMetaBoxes->addOption($this->fields[$counter]['name'], $this->fields[$counter]['default_value']);
            $counter++;
        }
    }
    ...
    public function render($factory)
    {
        ...
        <div class="mkdf-repeater-wrapper">
            <div class="mkdf-repeater-fields-holder mkdf-sortable-holder clearfix">
...
class MediclinicMikadoTableRepeater implements iMediclinicMikadoRender
{
    private $label;
    private $description;
    private $name;
    ...
    function __construct($fields, $name, $label = '', $description = '', $button_text = '')
    {
        ...
        $this->name = $name;
        $this->num_of_rows = 1;
        $this->button_text = !empty($button_text) ? $button_text : esc_html__('Add New', 'mediclinic');
    ...
    public function render($factory)
    {
        ...
        <div class="mkdf-repeater-wrapper mkdf-question-answers">
            <table class="mkdf-repeater-fields-holder mkdf-table-layout clearfix">
                <thead>
                    <tr>
                        <th><?php esc_html_e('Order', 'mediclinic') ?></th>
                        <?php foreach ($this->fields as $field) { ?>
                        <th><?php echo esc_html($field['th']); ?></th>
                        <?php } ?>
                        <th><?php esc_html_e('Remove', 'mediclinic') ?></th>
                    </tr>
                </thead>
...
class MediclinicMikadoParentChildRepeater implements iMediclinicMikadoRender
{
    private $num_of_rows;
    private $name;
    private $label;
