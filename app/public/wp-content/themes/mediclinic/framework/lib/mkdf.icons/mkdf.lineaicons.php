...
class MediclinicMikadoLineaIcons implements iMediclinicMikadoIconCollection {
	...
	public function __construct($title_label = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = MIKADO_ASSETS_ROOT . "/css/linea-icons/style.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="mkdf-icon-linea-icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
