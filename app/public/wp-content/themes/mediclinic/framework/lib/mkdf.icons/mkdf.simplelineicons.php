...
class MediclinicMikadoSimpleLineIcons implements iMediclinicMikadoIconCollection {
    ...
    public function __construct($title_label = "", $param = "") {
        ...
        $this->styleUrl = MIKADO_ASSETS_ROOT . "/css/simple-line-icons/simple-line-icons.css";
    }
    ...
    public function render($icon, $params = array()) {
        ...
        $html .= '<i class="mkdf-icon-simple-line-icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString .
            '></i>';
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'mediclinic'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'mediclinic'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'mediclinic'),
            'icon-social-facebook'    => esc_html__('Facebook', 'mediclinic'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'mediclinic'),
            'icon-social-github'      => esc_html__('Github', 'mediclinic'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'mediclinic'),
            'icon-social-instagram'   => esc_html__('Instagram', 'mediclinic'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'mediclinic'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'mediclinic'),
            'icon-social-reddit'      => esc_html__('Reddit', 'mediclinic'),
            'icon-social-skype'       => esc_html__('Skype', 'mediclinic'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'mediclinic'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'mediclinic'),
            'icon-social-spotify'     => esc_html__('Spotify', 'mediclinic'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'mediclinic'),
            'icon-social-twitter'     => esc_html__('Twitter', 'mediclinic'),
            'icon-social-youtube'     => esc_html__('Youtube', 'mediclinic')
        );
    }
