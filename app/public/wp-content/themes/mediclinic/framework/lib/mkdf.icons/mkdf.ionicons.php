...
class MediclinicMikadoIonIcons implements iMediclinicMikadoIconCollection {
	...
	function __construct($title_label = "", $param = "") {
		...
		$this->styleUrl = MIKADO_ASSETS_ROOT . "/css/ion-icons/css/ionicons.min.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="mkdf-icon-ion-icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
	...
	public function getSearchIcon() {
		...
		return $this->render('ion-ios-search-strong');
	}

	public function getSearchClose() {

		return $this->render('ion-close-round');
	}
