...
class MediclinicMikadoIconsFontAwesome implements iMediclinicMikadoIconCollection {
	...
	function __construct($title_label = "", $param = "") {
		...
		$this->styleUrl = MIKADO_ASSETS_ROOT . "/css/font-awesome/css/font-awesome.min.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="mkdf-icon-font-awesome fa ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
