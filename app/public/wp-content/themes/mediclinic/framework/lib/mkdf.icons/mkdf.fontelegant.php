...
class MediclinicMikadoIconsFontElegant implements iMediclinicMikadoIconCollection {
	...
	function __construct($title_label = "", $param = "") {
		...
		$this->styleUrl = MIKADO_ASSETS_ROOT . "/css/elegant-icons/style.min.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<span aria-hidden="true" class="mkdf-icon-font-elegant ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></span>';
