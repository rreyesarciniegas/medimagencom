	...
	tinymce.PluginManager.add('mkd_shortcodes', function( ed, url ) {
		ed.addButton( 'mkd_shortcodes', {
			...
			menu: [
				...
				{
					text: 'Inner Row Holder',
					onclick: function() {
						ed.windowManager.open( {
							title: 'Inner Row Holder Shortcode',
							body: [
								{
									type: 'listbox',
							...
							onsubmit: function( e ) {
								ed.insertContent( '[mkdf_inner_row_holder space_between_columns="' + e.data.space_between_columns + '" text_alignment="' + e.data.text_alignment + '"][mkdf_inner_row_column column_size="6"]Left column text content[/mkdf_inner_row_column][mkdf_inner_row_column column_size="6"]Right column text content[/mkdf_inner_row_column][/mkdf_inner_row_holder]');
							}
						});
					}
				},
